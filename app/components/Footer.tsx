    ...
    <footer className="bg-[#0f0f0f] text-gray-400 px-6 py-10  ">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div className="flex flex-col space-y-2">
          <h2 className="text-white text-xl font-extrabold">Links</h2>
        ...
        <div className="flex flex-col space-y-2">
  <h2 className="text-white text-xl font-extrabold">Luxury Brands</h2>
  <a href="/cars" className="footer-link">Lambohrgini</a>
  <a href="/cars" className="footer-link">BMW</a>
  <a href="/cars" className="footer-link">Dodge</a>
  <a href="/cars" className="footer-link">Porsche</a>
  <a href="/cars" className="footer-link">Rolls-Royce</a>
</div>
