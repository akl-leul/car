...
},
{
...
},
  {
    ...
    href: '#',
    price: '$2,300,000',
    imageSrc: 'https://media.hendy.co.uk/media/LOTUS/Features/Evija/D.0835_Hendy_Lotus_New_Car_Page_Images19.jpg.webp',
    imageAlt: 'Lotus Evija hypercar in electric yellow, side profile.',
    description: 'The world’s first British electric hypercar, fusing art and science with 2,000 hp of silent, surreal acceleration.',
    specs: {
      engineType: 'Quad Electric Motors',
      engineLiter: 'Fully Electric',
      horsepower: '1,972 hp',
  ...
  },
  {
    ...
    href: '#',
    price: '$12,195',
    imageSrc: 'https://imgd.aeplcdn.com/1280x720/n/cw/ec/175211/ce-04-right-side-view.jpeg?isig=0',
    imageAlt: 'BMW CE 04 futuristic electric scooter in white and orange.',
    description: 'Urban mobility, reimagined. This electric scooter is a rolling art piece with futuristic design and whisper-quiet performance.',
    specs: {
      engineType: 'Electric Motor',
      engineLiter: 'N/A',
      horsepower: '42 hp',
  ...
  },
  {
    ...
    href: '#',
    price: '$74,750',
    imageSrc: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQqMM4Sj_dC1dRVKyxI3R5eTtCRFKI5DOjkAw&s',
    imageAlt: 'Ariel Atom 4 open-wheel track car, exposed chassis.',
    description: 'A street-legal go-kart for adults. Minimal bodywork, maximum adrenaline, and a 0-60 time that will steal your breath.',
    specs: {
  ...
  {
    id: 28,
    name: 'Yamaha NIKEN GT',
    href: '#',
    price: '$17,299',
    imageSrc: 'https://ridermagazine.com/wp-content/uploads/2018/11/19_niken-gt_matte_phantom_blue_s3_rgb-web.jpg',
    imageAlt: 'Yamaha NIKEN GT three-wheeled motorcycle leaning in a curve.',
    description: 'The world’s first leaning three-wheeler motorcycle. Corner like a pro with radical stability and futuristic looks.',
    specs: {
      engineType: 'Inline-3',
      engineLiter: '847cc',
      horsepower: '115 hp',
